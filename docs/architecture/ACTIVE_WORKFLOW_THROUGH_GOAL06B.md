...
flowchart TD
    ...
    M -. "locked future explicit unlock required" .-> N["GOAL-09 Position Band Review-Only Unlock<br/>(locked_future; not implemented)"]
```
...
GOAL-09 and downstream trading/production workflow remain locked.
