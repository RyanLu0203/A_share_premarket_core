...
flowchart TD
    ...
    S01 -. "locked future prototype" .-> K3["GOAL-08B Recommendation Review-Only Prototype<br/>(locked_future)"]
...
hygiene; it does not unlock GOAL-08B. GOAL-08B remains `locked_future`. V2 factor
