# GOAL-PREMARKET-POSITION-MANAGEMENT-OPERATIONAL-01 Premarket Position Management
...
Execution mode: `daily_operational`. Target trading date: `2026-07-15`. Data cutoff: `2026-07-14`.

Daily readiness state: `READY_WITH_WARNINGS`.
