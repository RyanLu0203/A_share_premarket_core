...
diagnostics prototype, plus the GOAL-09.1 warning review and dashboard-readiness
gate.
...
as an explicit future design/contract gate. Actionable recommendations, actual
