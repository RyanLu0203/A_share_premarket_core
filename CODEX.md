...
review-only network-opt-in provider smoke testing. Preserve
...
- GOAL-DATA-PANEL-02, GOAL-V1-DIAGNOSTIC-COVERAGE-03, and GOAL-10B.3 remain
  `locked_future`.
...
- Do not create actionable recommendations, buy/sell/hold outputs, target
  ...
  panel evidence only; GOAL-DATA-PANEL-02, GOAL-V1-DIAGNOSTIC-COVERAGE-03,
  GOAL-10B.3, GOAL-10D, actual positions, dashboards, and execution remain
  locked.
