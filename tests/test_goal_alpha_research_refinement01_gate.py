...
def test_goal_alpha_research_refinement01_runner_preserves_boundaries() -> None:
    ...
    assert workflow["goal_alpha_factor_candidate02_refined_variants_research_gate"]["status"] == "locked_future"
    ...
    assert workflow["goal_rec_tiering01_recommendation_score_tiering_gate"]["depends_on"] == "goal_alpha_factor_candidate02_refined_variants_research_gate"
