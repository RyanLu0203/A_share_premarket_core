...
def test_goal_regime_label_research01_runner_preserves_research_only_boundaries() -> None:
    ...
    if workflow["goal_data_expansion_research01_market_regime_data_expansion_gate"]["status"] == "implemented_research_only":
        assert workflow["goal_data_expansion_research01_market_regime_data_expansion_gate"]["implemented_in_repo"] == "true"
    else:
        assert workflow["goal_data_expansion_research01_market_regime_data_expansion_gate"]["implemented_in_repo"] == "false"
