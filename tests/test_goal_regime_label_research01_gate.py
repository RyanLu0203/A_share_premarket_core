...
def test_goal_regime_label_research01_runner_preserves_research_only_boundaries() -> None:
    ...
    assert workflow["goal_quant_research04_regime_conditional_factor_evaluation_gate"]["depends_on"] == "goal_regime_label_research01_market_regime_label_construction_gate"
