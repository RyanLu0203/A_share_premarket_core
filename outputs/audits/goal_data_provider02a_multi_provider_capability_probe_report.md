...
- `baostock`: status `SKIPPED`, failure `provider_package_unavailable`, returned rows `0`, readiness `not_ready_optional_dependency_missing`.
- `akshare`: status `SKIPPED`, failure `network_disabled_by_policy`, returned rows `0`, readiness `cannot_assess_without_network_opt_in`.
- `efinance`: status `SKIPPED`, failure `provider_package_unavailable`, returned rows `0`, readiness `not_ready_optional_dependency_missing`.
...
- `yfinance`: status `SKIPPED`, failure `provider_package_unavailable`, returned rows `0`, readiness `not_ready_optional_dependency_missing`.
