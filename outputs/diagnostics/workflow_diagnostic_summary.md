...
GOAL-10B recommendation diagnostics backtest status: `PASS_WITH_WARNINGS`.
GOAL-10B audit status: `PASS`.
...
GOAL-V1-DIAGNOSTIC-COVERAGE-02 multi-symbol diagnostics status: `PASS_WITH_WARNINGS`.
GOAL-V1-DIAGNOSTIC-COVERAGE-02 audit status: `PASS`.
GOAL-V1-DIAGNOSTIC-COVERAGE-02 risk diagnostic rows: `8`.
GOAL-V1-DIAGNOSTIC-COVERAGE-02 unique symbols: `2`.
GOAL-V1-DIAGNOSTIC-COVERAGE-02 20d available: `false`.
GOAL-10B.2 recommendation revalidation status: `PASS_WITH_WARNINGS`.
GOAL-10B.2 audit status: `PASS`.
GOAL-10B.2 snapshot rows: `8`.
...
GOAL-QUANT-RESEARCH-01 factor lab status: `PASS_WITH_WARNINGS`.
GOAL-QUANT-RESEARCH-01 audit status: `PASS`.
GOAL-QUANT-RESEARCH-01 factors evaluated: `11`.
GOAL-QUANT-RESEARCH-01 evaluation rows: `66000`.
GOAL-QUANT-RESEARCH-01 ready factor count: `0`.
GOAL-QUANT-RESEARCH-01 score validity: `no_factor_ready_for_rec_tiering`.
GOAL-MVP-01 premarket terminal status: `PASS_WITH_WARNINGS`.
GOAL-MVP-01 audit status: `PASS`.
GOAL-MVP-01 report date: `2026-05-21`.
GOAL-MVP-01 symbol rows: `50`.
GOAL-MVP-01 ready factor count: `0`.
GOAL-ALPHA-FACTOR-CANDIDATE-01 status: `PASS_WITH_WARNINGS`.
...
GOAL-ALPHA-RESEARCH-REFINEMENT-01 status: `PASS_WITH_WARNINGS`.
GOAL-ALPHA-RESEARCH-REFINEMENT-01 audit status: `PASS`.
GOAL-ALPHA-RESEARCH-REFINEMENT-01 promising candidates diagnosed: `6`.
GOAL-ALPHA-RESEARCH-REFINEMENT-01 refined design rows: `30`.
GOAL-ALPHA-RESEARCH-REFINEMENT-01 trial registry rows: `34`.
GOAL-ALPHA-FACTOR-CANDIDATE-02 refined candidate construction status: `PASS_WITH_WARNINGS`.
GOAL-ALPHA-FACTOR-CANDIDATE-02 audit status: `PASS`.
GOAL-ALPHA-FACTOR-CANDIDATE-02 constructed refined candidate count: `30`.
GOAL-ALPHA-FACTOR-CANDIDATE-02 refined candidate panel rows: `180000`.
GOAL-ALPHA-FACTOR-CANDIDATE-02 trial registry rows: `30`.
