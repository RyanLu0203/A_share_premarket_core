...
PUBLIC_COMMANDS = [
    ...
    "scripts/run_goal_mvp01_premarket_research_terminal_gate.py",
    "scripts/audit_goal_mvp01_premarket_research_terminal_gate.py",
    "scripts/run_goal_alpha_factor_candidate01_gate.py",
    "scripts/audit_goal_alpha_factor_candidate01_gate.py",
    "scripts/run_goal_quant_research02_alpha_factor_evaluation_gate.py",
    "scripts/audit_goal_quant_research02_alpha_factor_evaluation_gate.py",
    "scripts/run_goal_alpha_research_refinement01_gate.py",
    "scripts/audit_goal_alpha_research_refinement01_gate.py",
    "scripts/run_goal_alpha_factor_candidate02_gate.py",
    "scripts/audit_goal_alpha_factor_candidate02_gate.py",
    "scripts/run_goal_quant_research03_refined_alpha_evaluation_gate.py",
    "scripts/audit_goal_quant_research03_refined_alpha_evaluation_gate.py",
    "scripts/run_goal_regime_label_research01_gate.py",
    "scripts/audit_goal_regime_label_research01_gate.py",
    "scripts/run_goal_architecture_refactor03_gate.py",
    "scripts/audit_goal_architecture_refactor03_gate.py",
    "scripts/run_goal_data_expansion_research01_gate.py",
    "scripts/audit_goal_data_expansion_research01_gate.py",
    ...
    "scripts/run_goal_factor_readiness_research01_factor_readiness_research_gate.py",
    "scripts/audit_goal_factor_readiness_research01_factor_readiness_research_gate.py",
    "scripts/run_goal_data_evidence_expansion02_upstream_evidence_expansion_gate.py",
    "scripts/audit_goal_data_evidence_expansion02_upstream_evidence_expansion_gate.py",
    "scripts/run_goal_network_evidence_ingestion01_authorized_network_evidence_ingestion_gate.py",
    "scripts/audit_goal_network_evidence_ingestion01_authorized_network_evidence_ingestion_gate.py",
    "scripts/acquire_goal_network_evidence_ingestion01.py",
    "scripts/run_goal_factor_readiness_rerun02.py",
    "scripts/audit_goal_factor_readiness_rerun02.py",
    "scripts/run_goal_factor_failure_attribution01.py",
    "scripts/audit_goal_factor_failure_attribution01.py",
    "scripts/run_goal_alpha_hypothesis_redesign01.py",
    "scripts/audit_goal_alpha_hypothesis_redesign01.py",
    "scripts/run_goal_liquidity_evidence_acceptance_contract01.py",
    "scripts/audit_goal_liquidity_evidence_acceptance_contract01.py",
    "scripts/run_goal_liquidity_evidence_acquisition_foundation01.py",
    ...
    "scripts/run_goal_liquidity_candidate_source_acceptance01.py",
    "scripts/audit_goal_liquidity_candidate_source_acceptance01.py",
    "scripts/run_goal_liquidity_external_handoff_readiness01.py",
    "scripts/audit_goal_liquidity_external_handoff_readiness01.py",
    "scripts/validate_liquidity_candidate_bundle.py",
    "scripts/validate_liquidity_schema_observation_bundle.py",
    ...
    "scripts/run_goal_premarket_position_management_operational01.py",
    "scripts/audit_goal_premarket_position_management_operational01.py",
    ...
    "scripts/run_ifind_provider_probe.py",
    "scripts/audit_tencent_primary_operational.py",
...
REQUIRED_OUTPUTS = [
    ...
    "configs/research/goal_quant_research02_alpha_factor_evaluation_contract.yaml",
    "docs/research/GOAL_QUANT_RESEARCH02_ALPHA_CANDIDATE_FACTOR_VALIDITY_EVALUATION_GATE.md",
    ...
    "outputs/audits/goal_quant_research02_alpha_factor_evaluation_manifest.json",
    ...
    "outputs/audits/goal_alpha_research_refinement01_manifest.json",
    ...
    "configs/research/goal_regime_label_research01_contract.yaml",
    "outputs/audits/goal_regime_label_research01_report.md",
    "outputs/audits/goal_regime_label_research01_manifest.json",
    "outputs/audits/goal_regime_label_research01_audit.md",
    "configs/architecture/goal_architecture_refactor03_contract.yaml",
    "configs/providers/akshare_source_catalog.yaml",
    "configs/providers/provider_registry.yaml",
    "docs/architecture/GOAL_ARCHITECTURE_REFACTOR03_AKSHARE_SOURCE_CATALOG_AND_PROVIDER_MODULARIZATION_GATE.md",
    ...
    "outputs/audits/goal_repository_checkpoint01_audit.md",
    ...
    "outputs/audits/goal_codex_operating_system01_audit.md",
