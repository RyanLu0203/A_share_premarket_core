        ...
        rows.append(
            {
                ...
                "business_purpose": "Preserve reproducible clean active workflow through GOAL-06B plus review-only GOAL-06C/GOAL-06D gates and GOAL-07A design-only governance.",
...
def write_active_trunk_module_map(root: Path) -> Path:
    rows = [
        ...
        for path, module, capability, owner, called, wrapper in [
            ...
            ("src/ashare_premarket/providers/browser_reference_probe.py", "ashare_premarket.providers.browser_reference_probe", "goal06c6a_browser_reference_probe", "GOAL-06C.6A", True, "scripts/run_cloakbrowser_reference_probe.py"),
            ("src/ashare_premarket/providers/provider_ladder.py", "ashare_premarket.providers.provider_ladder", "goal06c7_provider_ladder_engineering_data_base_expansion", "GOAL-06C.7", True, "scripts/run_goal06c7_provider_ladder_engineering_data_base_expansion.py"),
            ("src/ashare_premarket/providers/browser_assisted_provider.py", "ashare_premarket.providers.browser_assisted_provider", "goal06c7_browser_assisted_optional_provider", "GOAL-06C.7", True, "scripts/run_browser_assisted_finance_ingestion.py"),
            ("src/ashare_premarket/providers/browser_provider_policy.py", "ashare_premarket.providers.browser_provider_policy", "goal06c7_browser_assisted_optional_provider", "GOAL-06C.7", True, "scripts/audit_browser_assisted_provider.py"),
            ("src/ashare_premarket/providers/browser_provider_events.py", "ashare_premarket.providers.browser_provider_events", "goal06c7_browser_assisted_optional_provider", "GOAL-06C.7", True, "scripts/audit_browser_assisted_provider.py"),
            ("src/ashare_premarket/providers/browser_provider_switches.py", "ashare_premarket.providers.browser_provider_switches", "goal06c7_browser_assisted_optional_provider", "GOAL-06C.7", True, "scripts/audit_workflow_cleanliness.py"),
            ("src/ashare_premarket/providers/local_import_provider.py", "ashare_premarket.providers.local_import_provider", "goal06c7_provider_ladder_engineering_data_base_expansion", "GOAL-06C.7", True, "scripts/run_goal06c7_provider_ladder_engineering_data_base_expansion.py"),
            ("src/ashare_premarket/validation/workflow_cleanliness.py", "ashare_premarket.validation.workflow_cleanliness", "goal06c7_workflow_cleanliness", "GOAL-06C.7", True, "scripts/audit_workflow_cleanliness.py"),
...
def write_legacy_exclusion_manifest(root: Path) -> Path:
    rows = [
        ...
        },
        {
            ...
            "reason_for_exclusion": "Dashboard is locked downstream and out of GOAL-06C review-only validation scope.",
        ...
        },
        {
            ...
            "safe_to_exclude_from_target": True,
            "source_repo_reference": SOURCE_REPOSITORY,
            "restore_note": "Do not restore for GOAL-06C validation.",
            "notes": "Locked future only.",
        },
        {
    ...
    write_text(
        ...
        "\n".join(
            [
                ...
                "Class A active capabilities through GOAL-06B plus GOAL-06C review-only validation are represented by clean modules, wrappers, manifests, tests, and regenerated concise outputs.",
                "",
...
def _audit_for(capability_id: str) -> str:
    ...
    if capability_id == "goal07a_input_output_contracts":
        return "outputs/audits/goal07a_allowed_input_contract_audit.md;outputs/audits/goal07a_output_schema_audit.md;outputs/audits/goal07a_readiness_report.md"
    if capability_id == "goal07a_rules_state_warning_mapping":
