    ...
    write_text(
        ...
        "\n".join(
            [
                ...
                "",
                f"Status: `{status}`",
                "Public commands through GOAL-06B plus GOAL-06C/GOAL-06D review-only gates, the GOAL-07A design-only gate, the GOAL-07B.0 unlock gate, and the GOAL-07B review-only risk overlay prototype are preserved as clean wrappers.",
