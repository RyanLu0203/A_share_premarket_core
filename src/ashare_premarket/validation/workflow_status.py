...
GOAL_MVP01_ALLOWED_NEXT = "request_goal_alpha_factor_candidate01_before_recommendation_tiering"
...
GOAL_ALPHA_FACTOR_CANDIDATE02_ALLOWED_NEXT = "request_goal_quant_research03_refined_alpha_factor_validity_evaluation_gate"
GOAL_QUANT_RESEARCH03_WORKFLOW_ID = "goal_quant_research03_refined_alpha_factor_validity_evaluation_gate"
GOAL_QUANT_RESEARCH03_ALLOWED_NEXT_READY = "request_explicit_goal_rec_tiering01_after_goal_quant_research03_ready_factor"
GOAL_QUANT_RESEARCH03_ALLOWED_NEXT_WEAK = "request_goal_data_expansion_or_regime_label_research_before_more_alpha_expansion"
GOAL_REGIME_LABEL_RESEARCH01_WORKFLOW_ID = "goal_regime_label_research01_market_regime_label_construction_gate"
GOAL_REGIME_LABEL_RESEARCH01_ALLOWED_NEXT_READY = "request_goal_quant_research04_regime_conditional_factor_evaluation_gate"
GOAL_REGIME_LABEL_RESEARCH01_ALLOWED_NEXT_SPARSE = "request_goal_data_expansion_research01_before_regime_conditional_factor_evaluation"
...
def run_workflow_status_audit(root: Path) -> bool:
    ...
    if "GOAL-MVP-01 Premarket Research Diagnostic Terminal" not in full_roadmap or "implemented_mvp_research_only" not in full_roadmap:
    ...
    goal_mvp01 = by_id.get(GOAL_MVP01_WORKFLOW_ID, {})
    goal_mvp01_status = goal_mvp01.get("status")
    goal_mvp01_report = _read(root / "outputs/audits/goal_mvp01_premarket_terminal_report.md")
    goal_mvp01_manifest = _read(root / "outputs/audits/goal_mvp01_premarket_terminal_manifest.json")
    goal_mvp01_audit = _read(root / "outputs/audits/goal_mvp01_premarket_terminal_audit.md")
    goal_alpha_factor_candidate01 = by_id.get(GOAL_ALPHA_FACTOR_CANDIDATE01_WORKFLOW_ID, {})
    goal_alpha_factor_candidate01_status = goal_alpha_factor_candidate01.get("status")
    goal_alpha_factor_candidate01_report = _read(root / "outputs/audits/goal_alpha_factor_candidate01_report.md")
    ...
    goal_alpha_factor_candidate02_status = goal_alpha_factor_candidate02.get("status")
    goal_alpha_factor_candidate02_report = _read(root / "outputs/audits/goal_alpha_factor_candidate02_report.md")
    goal_alpha_factor_candidate02_manifest = _read(root / "outputs/audits/goal_alpha_factor_candidate02_manifest.json")
    goal_alpha_factor_candidate02_audit = _read(root / "outputs/audits/goal_alpha_factor_candidate02_audit.md")
    goal_quant_research03 = by_id.get(GOAL_QUANT_RESEARCH03_WORKFLOW_ID, {})
    goal_quant_research03_status = goal_quant_research03.get("status")
    goal_quant_research03_report = _read(root / "outputs/audits/goal_quant_research03_refined_alpha_evaluation_report.md")
    goal_quant_research03_manifest = _read(root / "outputs/audits/goal_quant_research03_refined_alpha_evaluation_manifest.json")
    goal_quant_research03_audit = _read(root / "outputs/audits/goal_quant_research03_refined_alpha_evaluation_audit.md")
    goal_regime_label_research01 = by_id.get(GOAL_REGIME_LABEL_RESEARCH01_WORKFLOW_ID, {})
    goal_regime_label_research01_status = goal_regime_label_research01.get("status")
    goal_regime_label_research01_report = _read(root / "outputs/audits/goal_regime_label_research01_report.md")
    goal_regime_label_research01_manifest = _read(root / "outputs/audits/goal_regime_label_research01_manifest.json")
    goal_regime_label_research01_audit = _read(root / "outputs/audits/goal_regime_label_research01_audit.md")
    goal_architecture_refactor03 = by_id.get(GOAL_ARCHITECTURE_REFACTOR03_WORKFLOW_ID, {})
    goal_architecture_refactor03_status = goal_architecture_refactor03.get("status")
    goal_architecture_refactor03_report = _read(root / "outputs/audits/goal_architecture_refactor03_report.md")
    ...
    goal_mvp01_evidence_ready = (
        bool(goal_mvp01)
        and goal_mvp01_status == "implemented_mvp_research_only"
        and _goal_mvp01_readiness_implemented(goal_mvp01_report)
        and "Status: `PASS`" in goal_mvp01_audit
    )
    goal_alpha_factor_candidate01_evidence_ready = (
        bool(goal_alpha_factor_candidate01)
    ...
    goal_alpha_factor_candidate02_evidence_ready = (
        bool(goal_alpha_factor_candidate02)
        and goal_alpha_factor_candidate02_status == "implemented_research_only"
        and _goal_alpha_factor_candidate02_readiness_implemented(goal_alpha_factor_candidate02_report)
        and "Status: `PASS`" in goal_alpha_factor_candidate02_audit
    )
    goal_quant_research03_evidence_ready = (
        bool(goal_quant_research03)
        and goal_quant_research03_status == "implemented_research_only"
        and _goal_quant_research03_readiness_implemented(goal_quant_research03_report)
        and "Status: `PASS`" in goal_quant_research03_audit
    )
    goal_regime_label_research01_evidence_ready = (
        bool(goal_regime_label_research01)
        and goal_regime_label_research01_status == "implemented_research_only"
        and _goal_regime_label_research01_readiness_implemented(goal_regime_label_research01_report)
        and "Status: `PASS`" in goal_regime_label_research01_audit
    )
    goal_architecture_refactor03_evidence_ready = (
        bool(goal_architecture_refactor03)
    ...
    expected_quant04_dependency = (
        ...
        if goal_architecture_refactor03_evidence_ready or goal_data_expansion_research01
        else GOAL_REGIME_LABEL_RESEARCH01_WORKFLOW_ID
    )
    if goal_regime_label_research01_evidence_ready or goal_regime_label_research01 or goal_quant_research04:
        expected_rec_dependency_for_research_chain = GOAL_QUANT_RESEARCH04_WORKFLOW_ID
    elif goal_alpha_factor_candidate02_evidence_ready or goal_quant_research03:
        expected_rec_dependency_for_research_chain = GOAL_QUANT_RESEARCH03_WORKFLOW_ID
    elif goal_alpha_research_refinement01_evidence_ready or goal_alpha_factor_candidate02:
    ...
    if goal_mvp01:
        if goal_mvp01_evidence_ready:
            if not goal_quant_research01_evidence_ready:
                failures.append("GOAL-MVP-01 requires GOAL-QUANT-RESEARCH-01 implemented_research_only evidence")
            if goal_mvp01.get("status") != "implemented_mvp_research_only":
                failures.append("GOAL-MVP-01 must be implemented_mvp_research_only when valid evidence exists")
            if goal_mvp01.get("implemented_in_repo") != "true":
                failures.append("GOAL-MVP-01 row must be marked implemented")
            if goal_mvp01.get("allowed_next_action") != GOAL_MVP01_ALLOWED_NEXT:
                failures.append("GOAL-MVP-01 allowed_next_action is invalid")
            if goal_mvp01.get("depends_on") != GOAL_QUANT_RESEARCH01_WORKFLOW_ID:
                failures.append("GOAL-MVP-01 must depend on GOAL-QUANT-RESEARCH-01")
            for required_text in [
                '"mode": "mvp_research_only_premarket_diagnostic_terminal"',
                '"run_mode": "committed_evidence_replay"',
                '"report_date": "2026-05-21"',
                '"symbol_table_row_count": 50',
                '"latest_panel_row_count": 50',
                ...
                if required_text not in goal_mvp01_manifest:
                    failures.append(f"GOAL-MVP-01 manifest missing required marker: {required_text}")
            for required_false in [
                ...
                '"future_returns_used_in_premarket_classification": false',
                '"recommendation_outputs_created": false',
                '"goal_rec_tiering01_run": false',
                '"goal10b4_run": false',
                '"position_band_validation_run": false',
                ...
                if required_false not in goal_mvp01_manifest:
                    failures.append(f"GOAL-MVP-01 manifest missing false boundary flag: {required_false}")
            if goal_alpha_factor_candidate01_evidence_ready:
                if goal_alpha_factor_candidate01.get("implemented_in_repo") != "true":
                    failures.append("GOAL-ALPHA-FACTOR-CANDIDATE-01 implemented row must be marked implemented")
            else:
                if goal_alpha_factor_candidate01.get("status") != "locked_future":
                    failures.append("GOAL-ALPHA-FACTOR-CANDIDATE-01 must remain locked_future after GOAL-MVP-01 until alpha evidence exists")
                if goal_alpha_factor_candidate01.get("implemented_in_repo") != "false":
            ...
            for workflow_id, row, expected_dependency in [
                (GOAL_REC_TIERING01_WORKFLOW_ID, goal_rec_tiering01, rec_dependency_after_mvp),
                (GOAL10B4_WORKFLOW_ID, goal10b4, GOAL_REC_TIERING01_WORKFLOW_ID),
                (POSITION_BAND_VALIDATION_WORKFLOW_ID, position_band_validation, GOAL10B4_WORKFLOW_ID),
            ]:
                if row.get("status") != "locked_future":
                    failures.append(f"{workflow_id} must remain locked_future after GOAL-MVP-01")
                if row.get("implemented_in_repo") != "false":
                    failures.append(f"{workflow_id} must not be implemented after GOAL-MVP-01")
                if row.get("depends_on") != expected_dependency:
                    failures.append(f"{workflow_id} dependency is invalid after GOAL-MVP-01")
            _validate_locked_execution_downstream(failures, by_id, context="GOAL-MVP-01")
        else:
            if goal_mvp01.get("status") != "locked_future" or goal_mvp01.get("implemented_in_repo") != "false":
                failures.append("GOAL-MVP-01 must remain locked_future until valid evidence exists")
    if goal_alpha_factor_candidate01:
        if goal_alpha_factor_candidate01_evidence_ready:
            if not goal_mvp01_evidence_ready:
                failures.append("GOAL-ALPHA-FACTOR-CANDIDATE-01 requires GOAL-MVP-01 implemented_mvp_research_only evidence")
            if goal_alpha_factor_candidate01.get("status") != "implemented_research_only":
                failures.append("GOAL-ALPHA-FACTOR-CANDIDATE-01 must be implemented_research_only when valid evidence exists")
            if goal_alpha_factor_candidate01.get("implemented_in_repo") != "true":
                failures.append("GOAL-ALPHA-FACTOR-CANDIDATE-01 row must be marked implemented")
            if goal_alpha_factor_candidate01.get("allowed_next_action") != GOAL_ALPHA_FACTOR_CANDIDATE01_ALLOWED_NEXT:
                failures.append("GOAL-ALPHA-FACTOR-CANDIDATE-01 allowed_next_action is invalid")
            if goal_alpha_factor_candidate01.get("depends_on") != GOAL_MVP01_WORKFLOW_ID:
                failures.append("GOAL-ALPHA-FACTOR-CANDIDATE-01 must depend on GOAL-MVP-01")
            for required_text in [
                '"mode": "research_only_alpha_factor_candidate_construction_gate"',
                '"candidate_registry_row_count": 13',
                '"constructed_candidate_count": 13',
                '"candidate_panel_row_count": 78000',
                '"unique_symbols": 50',
                '"unique_trade_dates": 120',
                '"source_backed_lineage_verified": true',
                ...
                if required_text not in goal_alpha_factor_candidate01_manifest:
                    failures.append(f"GOAL-ALPHA-FACTOR-CANDIDATE-01 manifest missing required marker: {required_text}")
            for required_false in [
                '"recommendation_outputs_created": false',
                ...
                '"factor_mining_outputs_created": false',
                '"dqn_rl_outputs_created": false',
                '"goal_quant_research02_run": false',
                '"goal_rec_tiering01_run": false',
                '"goal10b4_run": false',
                '"position_band_validation_run": false',
                '"live_provider_fetches_run": false',
                '"future_returns_used_in_alpha_construction": false',
                '"benchmark_excess_returns_used_in_alpha_construction": false',
                '"label_ready_fields_used_in_alpha_construction": false',
            ...
            for workflow_id, row, expected_dependency in [
                ...
                if row.get("status") != "locked_future":
                    failures.append(f"{workflow_id} must remain locked_future after GOAL-ALPHA-FACTOR-CANDIDATE-01")
                if row.get("implemented_in_repo") != "false":
    ...
    if goal_alpha_research_refinement01:
        if goal_alpha_research_refinement01_evidence_ready:
            ...
            if not goal_alpha_factor_candidate02_evidence_ready:
                for workflow_id, row, expected_dependency in [
    ...
    if goal_alpha_factor_candidate02:
        if goal_alpha_factor_candidate02_evidence_ready:
            if not goal_alpha_research_refinement01_evidence_ready:
                failures.append("GOAL-ALPHA-FACTOR-CANDIDATE-02 requires GOAL-ALPHA-RESEARCH-REFINEMENT-01 implemented_research_only evidence")
            if goal_alpha_factor_candidate02.get("status") != "implemented_research_only":
                failures.append("GOAL-ALPHA-FACTOR-CANDIDATE-02 must be implemented_research_only when valid evidence exists")
            if goal_alpha_factor_candidate02.get("implemented_in_repo") != "true":
                failures.append("GOAL-ALPHA-FACTOR-CANDIDATE-02 row must be marked implemented")
            if goal_alpha_factor_candidate02.get("allowed_next_action") != GOAL_ALPHA_FACTOR_CANDIDATE02_ALLOWED_NEXT:
                failures.append("GOAL-ALPHA-FACTOR-CANDIDATE-02 allowed_next_action is invalid")
            ...
            for required_text in [
                ...
                '"refined_candidate_design_count": 30',
                '"refined_candidate_registry_row_count": 30',
                '"constructed_refined_candidate_count": 30',
                '"refined_candidate_panel_row_count": 180000',
                '"source_alpha_refinement01_design_row_count": 30',
                '"source_alpha_candidate01_panel_row_count": 78000',
                '"source_quant02_evaluation_row_count": 78000',
                '"source_provider02b_row_count": 6000',
                ...
                if required_text not in goal_alpha_factor_candidate02_manifest:
                    failures.append(f"GOAL-ALPHA-FACTOR-CANDIDATE-02 manifest missing required marker: {required_text}")
            for required_false in [
                '"recommendation_outputs_created": false',
                '"recommendation_rows_created": false',
                '"position_rows_created": false',
                ...
                '"factor_mining_outputs_created": false',
                '"dqn_rl_outputs_created": false',
                '"goal_quant_research03_run": false',
                '"goal_rec_tiering01_run": false',
                '"goal10b4_run": false',
                '"position_band_validation_run": false',
                '"goal10d_run": false',
                '"live_provider_fetches_run": false',
                '"future_returns_used_in_refined_candidate_construction": false',
                '"benchmark_excess_returns_used_in_refined_candidate_construction": false',
                '"label_ready_fields_used_in_refined_candidate_construction": false',
                '"posthoc_performance_used_to_select_or_tune_formulas": false',
                '"predictive_validity_evaluated": false',
                '"predictive_validity_claimed": false',
                '"factor_promoted_to_recommendation_tiering": false',
            ]:
                if required_false not in goal_alpha_factor_candidate02_manifest:
                    failures.append(f"GOAL-ALPHA-FACTOR-CANDIDATE-02 manifest missing false boundary flag: {required_false}")
            for workflow_id, row, expected_dependency in [
                (GOAL_QUANT_RESEARCH03_WORKFLOW_ID, goal_quant_research03, GOAL_ALPHA_FACTOR_CANDIDATE02_WORKFLOW_ID),
                (GOAL_REC_TIERING01_WORKFLOW_ID, goal_rec_tiering01, expected_rec_dependency_for_research_chain),
                (GOAL10B4_WORKFLOW_ID, goal10b4, GOAL_REC_TIERING01_WORKFLOW_ID),
                (POSITION_BAND_VALIDATION_WORKFLOW_ID, position_band_validation, GOAL10B4_WORKFLOW_ID),
            ]:
                if workflow_id == GOAL_QUANT_RESEARCH03_WORKFLOW_ID and goal_quant_research03_evidence_ready:
                    if row.get("status") != "implemented_research_only":
                        failures.append(f"{workflow_id} must be implemented_research_only when valid evidence exists")
                    if row.get("implemented_in_repo") != "true":
                        failures.append(f"{workflow_id} implemented evidence must be marked implemented")
                elif row.get("status") != "locked_future":
                    failures.append(f"{workflow_id} must remain locked_future after GOAL-ALPHA-FACTOR-CANDIDATE-02")
                if not (workflow_id == GOAL_QUANT_RESEARCH03_WORKFLOW_ID and goal_quant_research03_evidence_ready) and row.get("implemented_in_repo") != "false":
                    failures.append(f"{workflow_id} must not be implemented after GOAL-ALPHA-FACTOR-CANDIDATE-02")
                if row.get("depends_on") != expected_dependency:
                    failures.append(f"{workflow_id} dependency is invalid after GOAL-ALPHA-FACTOR-CANDIDATE-02")
            _validate_locked_execution_downstream(failures, by_id, context="GOAL-ALPHA-FACTOR-CANDIDATE-02")
        else:
            if goal_alpha_factor_candidate02.get("status") != "locked_future" or goal_alpha_factor_candidate02.get("implemented_in_repo") != "false":
                failures.append("GOAL-ALPHA-FACTOR-CANDIDATE-02 must remain locked_future until valid evidence exists")
            if goal_alpha_factor_candidate02.get("depends_on") != GOAL_ALPHA_RESEARCH_REFINEMENT01_WORKFLOW_ID:
                failures.append("GOAL-ALPHA-FACTOR-CANDIDATE-02 must depend on GOAL-ALPHA-RESEARCH-REFINEMENT-01")
    if goal_quant_research03:
        if goal_quant_research03_evidence_ready:
            if not goal_alpha_factor_candidate02_evidence_ready:
                failures.append("GOAL-QUANT-RESEARCH-03 requires GOAL-ALPHA-FACTOR-CANDIDATE-02 implemented_research_only evidence")
            if goal_quant_research03.get("status") != "implemented_research_only":
                failures.append("GOAL-QUANT-RESEARCH-03 must be implemented_research_only when valid evidence exists")
            if goal_quant_research03.get("implemented_in_repo") != "true":
                failures.append("GOAL-QUANT-RESEARCH-03 row must be marked implemented")
            if goal_quant_research03.get("allowed_next_action") not in {
                GOAL_QUANT_RESEARCH03_ALLOWED_NEXT_READY,
                GOAL_QUANT_RESEARCH03_ALLOWED_NEXT_WEAK,
            }:
                failures.append("GOAL-QUANT-RESEARCH-03 allowed_next_action is invalid")
            if goal_quant_research03.get("depends_on") != GOAL_ALPHA_FACTOR_CANDIDATE02_WORKFLOW_ID:
                failures.append("GOAL-QUANT-RESEARCH-03 must depend on GOAL-ALPHA-FACTOR-CANDIDATE-02")
            for required_text in [
                '"mode": "research_only_refined_alpha_factor_validity_evaluation_gate"',
                '"evaluated_refined_factor_count": 30',
                '"source_candidate02_panel_row_count": 180000',
                '"refined_alpha_evaluation_panel_row_count": 180000',
                '"source_provider02b_row_count": 6000',
                '"coverage_summary_row_count": 30',
                '"ic_rankic_summary_row_count": 30',
                '"monotonicity_summary_row_count": 30',
                '"rolling_stability_summary_row_count": 30',
                '"horizon_consistency_summary_row_count": 30',
                '"improvement_summary_row_count": 30',
                '"score_validity_row_count": 30',
                '"trial_registry_row_count": 30',
                ...
                if required_text not in goal_quant_research03_manifest:
                    failures.append(f"GOAL-QUANT-RESEARCH-03 manifest missing required marker: {required_text}")
            for required_false in [
                '"recommendation_outputs_created": false',
                '"recommendation_rows_created": false',
                '"position_rows_created": false',
                ...
                '"benchmark_excess_returns_used_in_factor_construction": false',
                '"label_ready_fields_used_in_factor_construction": false',
                '"factor_formulas_tuned_to_future_returns": false',
                '"refined_formulas_altered_by_posthoc_evaluation": false',
                '"production_predictive_validity_claimed": false',
                '"factor_promoted_to_actionable_recommendation": false',
            ]:
                if required_false not in goal_quant_research03_manifest:
                    failures.append(f"GOAL-QUANT-RESEARCH-03 manifest missing false boundary flag: {required_false}")
            for workflow_id, row, expected_dependency in [
                (GOAL_REC_TIERING01_WORKFLOW_ID, goal_rec_tiering01, expected_rec_dependency_for_research_chain),
                (GOAL10B4_WORKFLOW_ID, goal10b4, GOAL_REC_TIERING01_WORKFLOW_ID),
                (POSITION_BAND_VALIDATION_WORKFLOW_ID, position_band_validation, GOAL10B4_WORKFLOW_ID),
                ...
                if row.get("status") != "locked_future":
                    failures.append(f"{workflow_id} must remain locked_future after GOAL-QUANT-RESEARCH-03")
                if row.get("implemented_in_repo") != "false":
                    failures.append(f"{workflow_id} must not be implemented after GOAL-QUANT-RESEARCH-03")
                if row.get("depends_on") != expected_dependency:
                    failures.append(f"{workflow_id} dependency is invalid after GOAL-QUANT-RESEARCH-03")
            _validate_locked_execution_downstream(failures, by_id, context="GOAL-QUANT-RESEARCH-03")
        else:
            if goal_quant_research03.get("status") != "locked_future" or goal_quant_research03.get("implemented_in_repo") != "false":
                failures.append("GOAL-QUANT-RESEARCH-03 must remain locked_future until valid evidence exists")
            if goal_quant_research03.get("depends_on") != GOAL_ALPHA_FACTOR_CANDIDATE02_WORKFLOW_ID:
                failures.append("GOAL-QUANT-RESEARCH-03 must depend on GOAL-ALPHA-FACTOR-CANDIDATE-02")
    if goal_regime_label_research01:
        if goal_regime_label_research01_evidence_ready:
            if not goal_quant_research03_evidence_ready:
                failures.append("GOAL-REGIME-LABEL-RESEARCH-01 requires GOAL-QUANT-RESEARCH-03 implemented_research_only evidence")
            if goal_regime_label_research01.get("status") != "implemented_research_only":
                failures.append("GOAL-REGIME-LABEL-RESEARCH-01 must be implemented_research_only when valid evidence exists")
            if goal_regime_label_research01.get("implemented_in_repo") != "true":
                failures.append("GOAL-REGIME-LABEL-RESEARCH-01 row must be marked implemented")
            if goal_regime_label_research01.get("allowed_next_action") not in {
                GOAL_REGIME_LABEL_RESEARCH01_ALLOWED_NEXT_READY,
                GOAL_REGIME_LABEL_RESEARCH01_ALLOWED_NEXT_SPARSE,
            }:
                failures.append("GOAL-REGIME-LABEL-RESEARCH-01 allowed_next_action is invalid")
            if goal_regime_label_research01.get("depends_on") != GOAL_QUANT_RESEARCH03_WORKFLOW_ID:
                failures.append("GOAL-REGIME-LABEL-RESEARCH-01 must depend on GOAL-QUANT-RESEARCH-03")
            for required_text in [
                '"mode": "research_only_market_regime_label_construction_gate"',
                '"date_regime_row_count": 120',
                '"symbol_regime_context_row_count": 6000',
                '"factor_regime_bridge_row_count": 180000',
                '"date_level_regime_table_created": true',
                '"symbol_regime_context_created": true',
                '"regime_coverage_summary_created": true',
                '"regime_transition_summary_created": true',
                '"factor_regime_bridge_created": true',
                '"construction_warnings_created": true',
                '"source_backed_lineage_verified": true',
                '"used_committed_provider02b_evidence_only": true',
                ...
                if required_text not in goal_regime_label_research01_manifest:
                    failures.append(f"GOAL-REGIME-LABEL-RESEARCH-01 manifest missing required marker: {required_text}")
            for required_false in [
            ...
            for workflow_id, row, expected_dependency in [
                ...
                if row.get("status") != "locked_future":
                    failures.append(f"{workflow_id} must remain locked_future after GOAL-REGIME-LABEL-RESEARCH-01")
                if row.get("implemented_in_repo") != "false":
                    failures.append(f"{workflow_id} must not be implemented after GOAL-REGIME-LABEL-RESEARCH-01")
                if row.get("depends_on") != expected_dependency:
                    failures.append(f"{workflow_id} dependency is invalid after GOAL-REGIME-LABEL-RESEARCH-01")
            _validate_locked_execution_downstream(failures, by_id, context="GOAL-REGIME-LABEL-RESEARCH-01")
        else:
            if goal_regime_label_research01.get("status") != "locked_future" or goal_regime_label_research01.get("implemented_in_repo") != "false":
                failures.append("GOAL-REGIME-LABEL-RESEARCH-01 must remain locked_future until valid evidence exists")
            if goal_regime_label_research01.get("depends_on") != GOAL_QUANT_RESEARCH03_WORKFLOW_ID:
                failures.append("GOAL-REGIME-LABEL-RESEARCH-01 must depend on GOAL-QUANT-RESEARCH-03")
    if goal_architecture_refactor03:
        if goal_architecture_refactor03_evidence_ready:
            if not goal_regime_label_research01_evidence_ready:
                failures.append("GOAL-ARCHITECTURE-REFACTOR-03 requires GOAL-REGIME-LABEL-RESEARCH-01 evidence")
            if goal_architecture_refactor03.get("status") != "implemented_engineering_research_support":
                failures.append("GOAL-ARCHITECTURE-REFACTOR-03 must be implemented_engineering_research_support when valid evidence exists")
            if goal_architecture_refactor03.get("implemented_in_repo") != "true":
                failures.append("GOAL-ARCHITECTURE-REFACTOR-03 row must be marked implemented")
            if goal_architecture_refactor03.get("allowed_next_action") != GOAL_ARCHITECTURE_REFACTOR03_ALLOWED_NEXT:
                failures.append("GOAL-ARCHITECTURE-REFACTOR-03 allowed_next_action is invalid")
            ...
            for workflow_id, row, expected_dependency in [
                ...
                if row.get("status") != "locked_future":
                    failures.append(f"{workflow_id} must remain locked_future after GOAL-ARCHITECTURE-REFACTOR-03")
                if row.get("implemented_in_repo") != "false":
                    failures.append(f"{workflow_id} must not be implemented after GOAL-ARCHITECTURE-REFACTOR-03")
                if row.get("depends_on") != expected_dependency:
                    failures.append(f"{workflow_id} dependency is invalid after GOAL-ARCHITECTURE-REFACTOR-03")
            _validate_locked_execution_downstream(failures, by_id, context="GOAL-ARCHITECTURE-REFACTOR-03")
        else:
            if goal_architecture_refactor03.get("status") != "locked_future" or goal_architecture_refactor03.get("implemented_in_repo") != "false":
                failures.append("GOAL-ARCHITECTURE-REFACTOR-03 must remain locked_future until valid evidence exists")
            if goal_architecture_refactor03.get("depends_on") != GOAL_REGIME_LABEL_RESEARCH01_WORKFLOW_ID:
                failures.append("GOAL-ARCHITECTURE-REFACTOR-03 must depend on GOAL-REGIME-LABEL-RESEARCH-01")
    if goal_data_expansion_research01:
        if goal_data_expansion_research01_evidence_ready:
            ...
            if goal_regime_label_research02:
                if goal_regime_label_research02.get("status") != "locked_future":
                    failures.append("GOAL-REGIME-LABEL-RESEARCH-02 must remain locked_future after GOAL-DATA-EXPANSION-RESEARCH-01")
                if goal_regime_label_research02.get("implemented_in_repo") != "false":
                    failures.append("GOAL-REGIME-LABEL-RESEARCH-02 must not be implemented after GOAL-DATA-EXPANSION-RESEARCH-01")
    ...
    write_text(
        ...
        "\n".join(
            [
                ...
                f"GOAL-QUANT-RESEARCH-03 status: `{goal_quant_research03.get('status', 'missing')}`.",
                f"GOAL-REGIME-LABEL-RESEARCH-01 status: `{goal_regime_label_research01.get('status', 'missing')}`.",
                f"GOAL-ARCHITECTURE-REFACTOR-03 status: `{goal_architecture_refactor03.get('status', 'missing')}`.",
                f"GOAL-DATA-EXPANSION-RESEARCH-01 status: `{goal_data_expansion_research01.get('status', 'missing')}`.",
                f"GOAL-QUANT-RESEARCH-04 status: `{goal_quant_research04.get('status', 'missing')}`.",
                ...
                "GOAL-ARCHITECTURE-REFACTOR-03 is engineering research-support metadata only and creates no data expansion, scientific output changes, recommendations, positions, portfolios, dashboards, trading, production, broker, local-lake, factor-mining, or DQN/RL outputs.",
                "",
                "## Failures",
...
def _validate_rows(rows: list[dict[str, str]]) -> list[str]:
    ...
    for row in rows:
        ...
        if workflow_id == GOAL_MVP01_WORKFLOW_ID:
            if status not in {"locked_future", "implemented_mvp_research_only"}:
                failures.append("goal_mvp01_premarket_research_terminal_gate must be locked_future or implemented_mvp_research_only")
            if status == "implemented_mvp_research_only":
                if row["implemented_in_repo"] != "true":
                    failures.append("goal_mvp01_premarket_research_terminal_gate implemented_mvp_research_only must be marked implemented")
                if row["allowed_next_action"] != GOAL_MVP01_ALLOWED_NEXT:
                    failures.append("goal_mvp01_premarket_research_terminal_gate allowed_next_action is invalid")
                if row["depends_on"] != GOAL_QUANT_RESEARCH01_WORKFLOW_ID:
                    failures.append("goal_mvp01_premarket_research_terminal_gate implemented row must depend on GOAL-QUANT-RESEARCH-01")
            else:
                if row["implemented_in_repo"] != "false":
                    failures.append("goal_mvp01_premarket_research_terminal_gate must remain unimplemented while locked_future")
                if row["depends_on"] != GOAL_QUANT_RESEARCH01_WORKFLOW_ID:
                    failures.append("goal_mvp01_premarket_research_terminal_gate locked row must depend on GOAL-QUANT-RESEARCH-01")
        if workflow_id == GOAL_ALPHA_FACTOR_CANDIDATE01_WORKFLOW_ID:
            if status not in {"locked_future", "implemented_research_only"}:
                failures.append("goal_alpha_factor_candidate01_research_gate must be locked_future or implemented_research_only")
            if status == "implemented_research_only":
                if row["implemented_in_repo"] != "true":
                    failures.append("goal_alpha_factor_candidate01_research_gate implemented_research_only must be marked implemented")
                if row["allowed_next_action"] != GOAL_ALPHA_FACTOR_CANDIDATE01_ALLOWED_NEXT:
                    failures.append("goal_alpha_factor_candidate01_research_gate allowed_next_action is invalid")
            else:
                if row["implemented_in_repo"] != "false":
                    failures.append("goal_alpha_factor_candidate01_research_gate must remain unimplemented while locked_future")
        ...
        if workflow_id == GOAL_ALPHA_FACTOR_CANDIDATE02_WORKFLOW_ID:
            if status not in {"locked_future", "implemented_research_only"}:
                failures.append("goal_alpha_factor_candidate02_refined_variants_research_gate must be locked_future or implemented_research_only")
            if status == "implemented_research_only":
                if row["implemented_in_repo"] != "true":
                    failures.append("goal_alpha_factor_candidate02_refined_variants_research_gate implemented_research_only must be marked implemented")
                if row["allowed_next_action"] != GOAL_ALPHA_FACTOR_CANDIDATE02_ALLOWED_NEXT:
                    failures.append("goal_alpha_factor_candidate02_refined_variants_research_gate allowed_next_action is invalid")
            else:
                if row["implemented_in_repo"] != "false":
                    failures.append("goal_alpha_factor_candidate02_refined_variants_research_gate must remain unimplemented while locked_future")
        ...
        if workflow_id == GOAL_QUANT_RESEARCH03_WORKFLOW_ID:
            if status not in {"locked_future", "implemented_research_only"}:
                failures.append("goal_quant_research03_refined_alpha_factor_validity_evaluation_gate must be locked_future or implemented_research_only")
            if status == "implemented_research_only":
                if row["implemented_in_repo"] != "true":
                    failures.append("goal_quant_research03_refined_alpha_factor_validity_evaluation_gate implemented_research_only must be marked implemented")
                if row["allowed_next_action"] not in {
                    GOAL_QUANT_RESEARCH03_ALLOWED_NEXT_READY,
                    GOAL_QUANT_RESEARCH03_ALLOWED_NEXT_WEAK,
                }:
                    failures.append("goal_quant_research03_refined_alpha_factor_validity_evaluation_gate allowed_next_action is invalid")
            else:
                if row["implemented_in_repo"] != "false":
                    failures.append("goal_quant_research03_refined_alpha_factor_validity_evaluation_gate must remain unimplemented while locked_future")
            if row["depends_on"] != GOAL_ALPHA_FACTOR_CANDIDATE02_WORKFLOW_ID:
                failures.append("goal_quant_research03_refined_alpha_factor_validity_evaluation_gate must depend on GOAL-ALPHA-FACTOR-CANDIDATE-02")
        if workflow_id == GOAL_REGIME_LABEL_RESEARCH01_WORKFLOW_ID:
            if status not in {"locked_future", "implemented_research_only"}:
                failures.append("goal_regime_label_research01_market_regime_label_construction_gate must be locked_future or implemented_research_only")
            if status == "implemented_research_only":
                if row["implemented_in_repo"] != "true":
                    failures.append("goal_regime_label_research01_market_regime_label_construction_gate implemented_research_only must be marked implemented")
                if row["allowed_next_action"] not in {
                    GOAL_REGIME_LABEL_RESEARCH01_ALLOWED_NEXT_READY,
                    GOAL_REGIME_LABEL_RESEARCH01_ALLOWED_NEXT_SPARSE,
                }:
                    failures.append("goal_regime_label_research01_market_regime_label_construction_gate allowed_next_action is invalid")
            else:
                if row["implemented_in_repo"] != "false":
                    failures.append("goal_regime_label_research01_market_regime_label_construction_gate must remain unimplemented while locked_future")
            if row["depends_on"] != GOAL_QUANT_RESEARCH03_WORKFLOW_ID:
                failures.append("goal_regime_label_research01_market_regime_label_construction_gate must depend on GOAL-QUANT-RESEARCH-03")
        if workflow_id == GOAL_ARCHITECTURE_REFACTOR03_WORKFLOW_ID:
            if status not in {"locked_future", "implemented_engineering_research_support"}:
                failures.append("goal_architecture_refactor03_akshare_source_catalog_and_provider_modularization_gate must be locked_future or implemented_engineering_research_support")
            if status == "implemented_engineering_research_support":
                if row["implemented_in_repo"] != "true":
                    failures.append("goal_architecture_refactor03_akshare_source_catalog_and_provider_modularization_gate implemented_engineering_research_support must be marked implemented")
                if row["allowed_next_action"] != GOAL_ARCHITECTURE_REFACTOR03_ALLOWED_NEXT:
                    failures.append("goal_architecture_refactor03_akshare_source_catalog_and_provider_modularization_gate allowed_next_action is invalid")
            else:
                if row["implemented_in_repo"] != "false":
                    failures.append("goal_architecture_refactor03_akshare_source_catalog_and_provider_modularization_gate must remain unimplemented while locked_future")
        ...
        if workflow_id == GOAL_REGIME_LABEL_RESEARCH02_WORKFLOW_ID:
            if status != "locked_future" or row["implemented_in_repo"] != "false":
                failures.append("goal_regime_label_research02_expanded_market_regime_label_refinement_gate must remain locked_future and unimplemented")
        ...
        if workflow_id == GOAL_QUANT_RESEARCH04_WORKFLOW_ID:
            ...
            if row["depends_on"] != expected_quant04_dependency:
                failures.append("goal_quant_research04_regime_conditional_factor_evaluation_gate dependency is invalid")
        if workflow_id == GOAL_REC_TIERING01_WORKFLOW_ID:
            ...
            if GOAL_QUANT_RESEARCH04_WORKFLOW_ID in by_id:
                expected_risk_dependency = GOAL_QUANT_RESEARCH04_WORKFLOW_ID
            elif GOAL_REGIME_LABEL_RESEARCH01_WORKFLOW_ID in by_id:
                expected_risk_dependency = GOAL_QUANT_RESEARCH04_WORKFLOW_ID
            elif GOAL_QUANT_RESEARCH03_WORKFLOW_ID in by_id:
                expected_risk_dependency = GOAL_QUANT_RESEARCH03_WORKFLOW_ID
            elif GOAL_ALPHA_FACTOR_CANDIDATE02_WORKFLOW_ID in by_id:
...
def _status_table_row(row: dict[str, str]) -> dict[str, object]:
    ...
    if status == "implemented_active":
        ...
        can_promote = False
        blocker = "already implemented MVP research-only; downstream execution remains locked"
    ...
    if row["workflow_id"] == "goal06c_expanded_validation_ranking":
        ...
        next_goal = "GOAL-MVP-01 premarket research terminal summarizes committed evidence before alpha-factor candidate research"
    elif row["workflow_id"] == GOAL_MVP01_WORKFLOW_ID:
        next_goal = "GOAL-ALPHA-FACTOR-CANDIDATE-01 alpha candidate research is implemented when evidence exists"
        ...
        next_goal = "GOAL-ALPHA-FACTOR-CANDIDATE-02 constructs refined candidates only after explicit research-only authorization"
    elif row["workflow_id"] == GOAL_ALPHA_FACTOR_CANDIDATE02_WORKFLOW_ID:
        next_goal = "GOAL-QUANT-RESEARCH-03 refined-alpha validity evaluation is implemented when valid evidence exists"
    elif row["workflow_id"] == GOAL_QUANT_RESEARCH03_WORKFLOW_ID:
        next_goal = "GOAL-REGIME-LABEL-RESEARCH-01 market regime label construction is the implemented research-only successor before Quant04"
        ...
        next_goal = "Remain locked until explicit GOAL-REC-TIERING-01 request after regime-conditional factor evidence is accepted"
...
def _goal_mvp01_readiness_implemented(readiness: str) -> bool:
    return (
        "GOAL-MVP-01 Premarket Research Diagnostic Terminal Gate: PASS" in readiness
        or "GOAL-MVP-01 Premarket Research Diagnostic Terminal Gate: PASS_WITH_WARNINGS" in readiness
    )


def _goal_alpha_factor_candidate01_readiness_implemented(readiness: str) -> bool:
    return (
...
def _goal_alpha_factor_candidate02_readiness_implemented(readiness: str) -> bool:
    return (
        "GOAL-ALPHA-FACTOR-CANDIDATE-02 Refined Alpha Candidate Construction Gate: PASS" in readiness
        or "GOAL-ALPHA-FACTOR-CANDIDATE-02 Refined Alpha Candidate Construction Gate: PASS_WITH_WARNINGS" in readiness
    )


def _goal_quant_research03_readiness_implemented(readiness: str) -> bool:
    return (
        "GOAL-QUANT-RESEARCH-03 Refined Alpha Factor Validity Evaluation Gate: PASS" in readiness
        or "GOAL-QUANT-RESEARCH-03 Refined Alpha Factor Validity Evaluation Gate: PASS_WITH_WARNINGS" in readiness
    )


def _goal_regime_label_research01_readiness_implemented(readiness: str) -> bool:
    return (
        "GOAL-REGIME-LABEL-RESEARCH-01 Market Regime Label Construction Gate: PASS" in readiness
        or "GOAL-REGIME-LABEL-RESEARCH-01 Market Regime Label Construction Gate: PASS_WITH_WARNINGS" in readiness
    )


def _goal_architecture_refactor03_readiness_implemented(readiness: str) -> bool:
    return (
