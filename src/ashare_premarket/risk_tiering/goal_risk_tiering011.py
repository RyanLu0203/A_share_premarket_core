...
def audit_goal_risk_tiering011_downside_risk_repair_gate(root: Path) -> bool:
    ...
    if workflow.get("goal_alpha_factor_candidate01_research_gate", {}).get("status") == "implemented_research_only":
        valid_rec_dependencies.add("goal_quant_research02_alpha_candidate_factor_validity_evaluation_gate")
